...
export { default as navLayout } from '../layouts/navLayout';
...
// export { default as ProtectedData } from '../../backend/components/securite/protectedData';
export { default as Profile } from '../pages/Profile';
export { default as Service } from '../pages/Service';
export { default as Signup } from '../pages/SignUp';
// essayer de le mettre en place plus tard pour remplacer les imports de fichiers dans publicRouter