...
const FooterLayout = () => {
    ...
    return (
        ...
        <div className="footer">
            <p className="preventionMessage mt-10 mb-10 text-center">L 'entretien de votre installation de chauffage est obligatoire, que vous soyez propriétaire ou locataire. Cet entretien améliore la longévité de votre
