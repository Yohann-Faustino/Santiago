...
const Login = () => {
  ...
  const [loginConnexion, setLoginConnexion] = useState({
    email: 'yohannfaustino@gmail.com', // Mis les valeurs de bases correctes pour me connecter sans les saisirs à chaque fois.
    password: 'Yohann666!' // Mis les valeurs de bases correctes pour me connecter sans les saisirs à chaque fois.
  })
