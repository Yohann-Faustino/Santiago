    ...
    return (
        ...
        <div className="homeBlock flex flex-row">
            <div className="homeLeftBlock w-1/2">
                <h1 className=" text-red-700 flex flex-row">La société<Link to="/legaldisclaimer"><img className="h-4 ml-3" src={Decp} alt="Nom de l'entreprise" /></Link></h1>
                <p className=" mb-5 text-blue-900" >Dégorgement, Entretien, Chauffage, Plomberie.</p>
                ...
                <h2 className="mt-5 text-red-700">Services:</h2>
                <p className=" mb-5 text-blue-900">Entretien, Installation, Rénovation.</p>
                <ul>
            ...
            <div className="homeRigthBlock w-1/2 ml-5">
                <h2 className=" text-red-700">Contact:</h2>
                <ul>
                    <li className=" text-blue-900">24 HEURES SUR 24 / 7 JOURS SUR 7</li>
                    <li className=" text-blue-900"><a href="tel:+33695451933"> 📞 06.95.45.19.33</a></li>
                    <li className=" text-blue-900"><a href="mailto:decp@decp.fr">📧 decp@decp.fr</a></li>
                </ul>
                <h2 className=" mt-5 mb-5 text-red-700">Apparut sur le site de recommandation d'artisants aude-location:</h2>
